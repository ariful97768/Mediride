    ...
    <section className="relative bg-navy overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div
          ...
          // Replace this URL with your local image path (e.g., '/images/hero-van.jpg')
          style={{
        ...
        <div className="absolute inset-0 bg-linear-to-r from-navy from-10% via-navy/90 via-40% to-transparent to-80% sm:to-transparent/10 z-10" />
      </div>

      {/* Main Content */}
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32 lg:pt-20 lg:pb-22">
        <div className="max-w-xl lg:max-w-2xl text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
            <a
              href="#book"
              className="bg-teal text-white text-center px-8 py-3.5 rounded-full font-bold text-lg hover:bg-opacity-90 transition shadow-lg w-full sm:w-auto"
            >
              Book Your Ride
            </a>
            <a
              href="tel:5551234567"
              className="border-2 border-white text-white text-center px-8 py-3.5 rounded-full font-bold text-lg hover:bg-white hover:text-navy transition w-full sm:w-auto"
            >
          ...
          <div>
            <a
              ...
              className="text-white hover:text-teal font-medium inline-flex items-center transition-colors group"
            >
...
function FeatureItem({ icon, text }: { icon: React.ReactNode; text: string }) {
  return (
    <div className="py-4 px-2 flex items-center justify-center sm:justify-start gap-2">
      {icon}
